...
export async function createRoute(projectId, data) {
    const {
        route_id,
        route_short_name,
        route_long_name,
...
export async function updateRoute(projectId, routeId, data) {
